<?php
    ...
    else
    {
        ...
        require_once("db.php");
        $queryx="SELECT * FROM doctor where username='$username';";
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-left" style="margin-top:0px;">
                    <li><a href="docinterface.php">HOME</a>
                    </li>
                    ...
                    <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding-top: 8px;padding-bottom: 12px;"><?php echo $r['name']." "; ?><img src="images/doctor/<?php echo $r['image']; ?>" style="height:30px; width:30px;"> <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu" style="background-color:#444;">
                        <li><a href="docprofile.php">Profile</a></li>
                        <li><a href="doceditprofile.php">Edit Profile</a></li>
                        <li><a href="logoutdoc.php">Log Out</a></li>
                    </ul>
                    </li>
                </ul>
				<br>
