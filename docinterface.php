...
<body>
	...
	<div class="container" id="home">
		...
		<br><br><br><br><br>
             <img src="images/healthcare-mechanism.jpg" width=600 height=300>
          </div>
    </div>
	...
	<div class="butons">
			 <a href='appointments.html'><button type="button" style="width:200px;height:50px">Appointments</button></a><br><br>
			 <a href='prescription.html'><button type="button" style="width:200px;height:50px">Prescription</button></a>
	</div>
    <!--End Header section  -->
