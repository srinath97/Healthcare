        ...
        <div class="row">
            ...
            <br><br><br><br><br>
                        ...
                        <form role="form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter Doctor Type" required name="type" autofocus>
                                </div>
                                
                                <!-- Change this to a button or input when using this as a form -->
                                <button class="btn btn-lg btn-success btn-block" name="submit">Add Doctor Type</button>
                            </fieldset>
                        </form>
                        <?php
                            if(isset($_POST['submit']))
                            {
                                ...
                                $query3="SELECT * FROM doctortype where type='$type';";
                                $result3=mysqli_query($stat,$query3);
                                if(mysqli_num_rows($result3)==0)
                                {
                                    $query3="INSERT INTO doctortype(type) VALUES('$type');";
                                    $result3=mysqli_query($stat,$query3);
                                    ?>  
                                    <script>
                                        var msg="Doctor Type succesfully inserted!!";
                                    </script>
                                    <?php
                                }
                                else
                ...
                <div class="col-sm-7" style="margin-left:90px">
                  <center><h1 style="margin:-30px;font-size:40px">List of Doctor Types</h1></center>
                    <section class="panel">
                      ...
                      <table class="table table-bordered table-hover table-striped">
                          <tr>
                             ...
                             <th><b>Type</b></th>
                              ...
                              <?php
                              require_once("db.php");
                              $q="SELECT * FROM doctortype ORDER BY type;";
